...
async def post_init(app: Application) -> None:
    ...
    await app.bot.set_my_commands(
        [
            ...
            BotCommand("anime", "Busca o anime e deixa voce escolher a faixa"),
            BotCommand("op", "Busca aberturas e deixa voce escolher"),
            BotCommand("ed", "Busca encerramentos e deixa voce escolher"),
        ]
    )
