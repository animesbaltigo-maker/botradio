...
CONTROL_AGENT_PORT = int(os.getenv("CONTROL_AGENT_PORT", "8786"))
CONTROL_BOT_ID = os.getenv("CONTROL_BOT_ID", "radio").strip() or "radio"
CONTROL_BOT_NAME = os.getenv("CONTROL_BOT_NAME", "RadioAnimes_Bot").strip() or CONTROL_BOT_ID
CONTROL_CHANNEL_USERNAME = os.getenv("CONTROL_CHANNEL_USERNAME", "@RadioAnimes").strip()
