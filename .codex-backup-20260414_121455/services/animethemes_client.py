...
DEFAULT_INCLUDE = "animethemes.animethemeentries.videos.audio"
...
class AnimeThemesClient:
    ...
    async def get_random_track(self, theme_type: str | None = None) -> ThemeTrack:
        for _ in range(8):
    ...
    async def get_track_for_query(self, query: str, theme_type: str | None = None) -> ThemeTrack:
    ...
    async def get_track_for_slug(self, slug: str, theme_type: str | None = None) -> ThemeTrack:
